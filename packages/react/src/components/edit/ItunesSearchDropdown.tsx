...
export function ItunesSearchDropdown({
  ...
  return (
    ...
    >
      ...
      {open &&
        (autocomplete?.length ? (
          <CommandList className="border-base absolute top-10 z-10 w-full rounded-b-md border border-solid">
  ...
  return (
    <div className="flex w-full flex-row gap-2">
      ...
      <div className="grow">
        ...
        <div className="">
          <div className="i-heroicons:musical-note mr-1 -mb-1 inline-block text-sm"></div>
        ...
        <div className="text-xs">
          ...
          <span
            className="ml-5 inline-block rounded px-1 text-xs font-bold"
