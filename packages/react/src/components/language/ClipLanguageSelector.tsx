      ...
      <PopoverTrigger asChild>
        ...
        >
          <div className="relative h-6 w-6">
            <div className="i-tabler:language-hiragana absolute mt-1 h-full w-full opacity-80" />
            <div
              className="i-mdi:gear absolute inset-0 mb-auto ml-auto h-full w-full"
            ...
            <CommandGroup heading={t("views.settings.clipLanguageSelection")}>
              <CommandItem disabled className="p-0">
                {selectedLangs.length > 0 && (
                  <div className="mb-1 flex w-full flex-wrap gap-1 border-b p-2 pt-0">
