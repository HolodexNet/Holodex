<template>
  <v-row>
    <v-col :cols="2">
      <kbd>Video Card</kbd>
      <div><video-card :video="video" /></div>
    </v-col>
  </v-row>
</template>
...
const video = {
  id: "k8UuJxhGQf8",
  title:
    "【Golf It!】誰が一番のゴルファーか決めようか⛳【ホロライブ/夏色まつり】",
  type: "stream",
  topic_id: "Golf_It!",
  published_at: "2022-06-13T05:12:30.000Z",
  available_at: "2022-06-14T14:00:00.000Z",
  duration: 0,
  status: "upcoming",
  start_scheduled: "2022-06-14T14:00:00.000Z",
  live_viewers: 0,
  mentions: [
    {
  ...
  channel: {
    ...
    type: "vtuber",
    photo:
      "https://yt3.ggpht.com/wIqM7MWDN94PoibzPmeog7WOt8jFKTKZBOBFEbLBaiUAdKLwoqdLC_CN7B7Gby-FWH-076rN=s800-c-k-c0x00ffffff-no-rj",
