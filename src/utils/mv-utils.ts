...
export const desktopPresets = Object.freeze([
    ...
    { layout: "AAOM,AMOM,OAFYchat,TAFYchat", name: "2 Video, 2 Chat", default: 2 },
    { layout: "AAMY,MAMM,MMMM", name: "p1s2", default: 3 },
    { layout: "AAMM,AMMM,MAMM,MMGMchat,SMGMchat", name: "3 Video, 2 Chat" },
    { layout: "AAMM,AMMM,MAMM,MMMM", name: "2 x 2" },
    { layout: "AAKM,KAKM,UAEMchat0,AMKM,KMKM,UMEMchat0", name: "2x2 4 Chat", default: 4 },
    ...
    { layout: "AAIM,AMIM,IAIM,QMIM,QAIM,MMEMchat0,IMEMchat0", name: "5 Video", default: 5 },
    { layout: "AAIM,AMIM,IAIM,IMIM,QAIM,QMIM", name: "2 x 3", default: 6 },
    { layout: "AAQQ,AQII,IQII,QAII,QIII,QQII", name: "p1s5" },
    { layout: "AAJM,AMJM,JAJM,JMJM,SAGI,SIGI,SQGI", name: "7 Videos", default: 7 },
    { layout: "AAII,AIII,AQII,IAII,IIII,IQII,QAII,QIII,QQII", name: "3 x 3", default: 9 },
    {
